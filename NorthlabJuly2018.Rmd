...
knitr::include_graphics("dating-meme.jpg") # source: https://imgflip.com/i/1fnpa8
```
...
* We had [Sam Roberts](https://www.ljmu.ac.uk/about-us/staff-profiles/faculty-of-science/natural-sciences-and-psychology/samuel-roberts) giving a talk at psychology a while ago.
...
* Can people tell how 'groupy' their facebook network is. (Just published in [_Social Science Research_](https://www.sciencedirect.com/science/article/pii/S0049089X17306919)).
...
```{r, out.width = "500px", echo=FALSE, fig.align='center'}
knitr::include_graphics("future.jpg")
```
...
* Open to add more, among others set up collaborations with PACT and NorthLab. Depending on where my expertise fits in ... .
...
* Workshop with PACT lab (initially planned for summer - but likely fall or spring)? Half a day? Interest in R and/or data visualisation? 
